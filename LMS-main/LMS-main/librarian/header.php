<?php
//echo $_SERVER['PHP_SELF'];                which page is this
 $page = explode('/',$_SERVER['PHP_SELF']);

// $page = $page[count($page)-1]; this technique is little bit complex
$page = end($page);

// to pick the last page
        ...
        <div class="rightside-header">
            ...
            <div class="header-section" id="user-headerbox">
                <div class="user-header-wrap">
                    ...
                    <div class="user-info">
                        <span class="user-name">Shammo</span>
